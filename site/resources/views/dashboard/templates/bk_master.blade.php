...
<head>
    ...
    <meta charset="utf-8">
    <title>@yield('title') - MCenterNTW Dashboard</title>
        ...
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" class="navbar navbar-default navbar-static-top">
            ...
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="/assets/dashboard/images/avatar/48.jpg" alt="" class="img-responsive img-circle"/>&nbsp;<span class="hidden-xs">Robert John</span>&nbsp;<span class="caret"></span></a>
        ...
        <div id="chat-form" class="fixed">
            <div class="chat-inner">
                <h2 class="chat-header">
                    <a href="javascript:;" class="chat-form-close pull-right"><i class="fa fa-times">
            ...
            <div id="chat-box" style="top: 400px">
                ...
                <div class="chat-content">
                    <ul class="chat-box-body">
                        <li>
                            <p>
                                <img src="/assets/dashboard/images/avatar/128.jpg" class="avt" /><span class="user">John Doe</span><span
                        ...
                        <li class="odd">
                            <p>
                                <img src="/assets/dashboard/images/avatar/48.jpg" class="avt" /><span class="user">Swlabs</span><span
                                        class="time">09:33</span></p>
                            <p>
                            ...
                            <div class="portlet box">
                                ...
                                <div class="portlet-body">
                                    <div class="chat-scroller">
                                        <ul class="chats">
                                            <li class="in">
                                                <img src="/assets/dashboard/images/avatar/48.jpg" class="avatar img-responsive" />
                                                <div class="message">
                                    ...
                                    <div class="profile">
                                        <div style="margin-bottom: 15px" class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4 text-center">
                                                <figure><img src="/assets/dashboard/images/avatar/128.jpg" alt="" style="display: inline-block" class="img-responsive img-circle"/>
